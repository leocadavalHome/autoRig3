...
# todo fazer novo eyebrow
# todo spine ribbon bezier
# todo mudar setagem de dedos e numero de joints ao reconstruir
#
# todo possibilidade de criar moveall para props

# todo acertar a interpolacao do ik fk dos limbs
# todo alinhar o fk dos pes

# todo tamanho dos controles do modulo moveall
# todo usar controles certos no eyelid

# todo conectar dedos na base do guide da mao
# todo mudar sulfixo do controle global dos dedos (cntrl para ctrl)

# todo tirar lookAt follow head
# todo arrumar a rotacao do joint do olho lookAt

# todo adicionar modo q nao retire influencias nao usadas no copyskin
# todo zero group manter o parent
# todo arrumar o autoSkin pra aceitar malha sem skin

# todo adicionar controle gear
# todo adicionar layers
# todo construir modulo facial dos tweaks
# todo contruir modulo facial do headBend
# todo reaplicar tamanho dos controles ao reconstruir rig
#
