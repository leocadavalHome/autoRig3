...
import autoRig3.ui.bodyRigWidget as bodyRigWidget
...
class BodyRigUI(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super(BodyRigUI, self).__init__(parent=parent)

        self.templateUI = None
        self.ui = bodyRigWidget.Ui_autoRig()
