...
class Biped:
    ...
    def setDefaultDicts(self):
        ...
        self.rarm.limbDict = {'moveallGuideSetup': {'nameTempl': 'R_armMoveAll', 'icone': 'quadradoX', 'color': (1, 1, 0), 'size': 1},
        ...
        self.rhand.handDict = {
                        ...
                        'finger5': {'fold2CntrlSetup': {'nameTempl': u'R_handPinkyfold2', 'icone': 'circuloX',
                        ...
                        'finger2': {'fold2CntrlSetup': {'nameTempl': u'R_handIndexfold2', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3},
                                    'folds': 2,
                        ...
                        'finger3': {'fold2CntrlSetup': {'nameTempl': u'R_handMiddlefold2', 'icone': 'circuloX',
                        ...
                        'finger1': {'fold2CntrlSetup': {'nameTempl': u'R_handThumbfold2', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3},
                                    'folds': 1,
            ...
            'moveallGuideSetup': {'nameTempl': 'R_handMoveAll', 'icone': 'quadradoX', 'size': 1.5, 'color': (1, 0, 0)},
        ...
        self.lhand.handDict = {
            'fingers': {'finger4': {
                        ...
                        'finger5': {'fold2CntrlSetup': {'nameTempl': u'L_handPinkyfold2', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3},
                                    'folds': 2,
                        ...
                        'finger2': {'fold2CntrlSetup': {'nameTempl': u'L_handIndexfold2', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3},
                                    'folds': 2,
                        ...
                        'finger3': {'fold2CntrlSetup': {'nameTempl': u'L_handMiddlefold2', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3}, 'folds': 2,
                        ...
                        'finger1': {'fold2CntrlSetup': {'nameTempl': u'L_handThumbfold2', 'icone': 'circuloX',
                                    ...
                                    'fold1CntrlSetup': {'nameTempl': u'L_handThumbfold1', 'icone': 'circuloX',
                                                        'color': (0, 1, 1), 'size': 0.3}, 'flipAxis': False}},
            'moveallGuideSetup': {'nameTempl': 'L_handMoveAll', 'icone': 'quadradoX', 'size': 1.5,'color': (1, 0, 0)},
            'flipAxis': False,
            'name': 'L_hand',
            'guideDict': {'moveall': [(8.13, 21.04, 0.0), (0.0, 0.0, 0.0)]},
            'axis': 'X'}

        self.lfoot.footDict = {'slideCntrlSetup': {'nameTempl': 'L_footSlide', 'icone': 'bola', 'color': (1, 0, 0), 'size': 0.4},
        ...
        self.rfoot.footDict = {'slideCntrlSetup': {'nameTempl': 'R_footSlide', 'icone': 'bola', 'color': (1, 0, 0), 'size': 0.4},
        ...
        self.neck.neckDict = {
                    ...
                    'moveallGuideSetup': {'nameTempl': 'neckMoveall', 'icone': 'quadradoY', 'size': 2.5,
                                              'color': (1, 0, 0)},
        ...
        self.spine.spineDict = {
                     ...
                     'endIkCntrlSetup': {'nameTempl': 'spineChestIk', 'icone': 'circuloPontaY', 'color': (1, 0, 0),
                                         'size': 4}}
        self.lclav.chainDict = {
                    'moveallGuideSetup': {'nameTempl': 'L_clavicleMoveAll', 'icone': 'quadradoX',
        ...
        self.rclav.chainDict = {
                     'name': 'R_clavicle',
                     'moveallGuideSetup': {'nameTempl': 'R_clavicleMoveAll', 'icone': 'quadradoX',
                                  'size': 2.5, 'color': (1, 0, 0)},
        ...
        self.llegShoulder.chainDict = {'name': 'L_legShoulder',
                                       'moveallGuideSetup': {'nameTempl': 'L_legShoulderMoveAll', 'icone': 'quadradoX',
                                                             'size': 2.5, 'color': (1, 0, 0)},
                            ...
                            'axis': 'X'}
        self.rlegShoulder.chainDict = {'name': 'R_legShoulder',
                                       'moveallGuideSetup': {'nameTempl': 'R_legShoulderMoveAll', 'icone': 'quadradoX',
                                                             'size': 2.5, 'color': (1, 0, 0)},
        ...
        self.master.moveallDict ={'name': self.name,
                                  'conn': self.connType,
                                  'guideDict': {'moveall': [(0, 0, 0), (0, 0, 0)]},
                                  'moveallGuideSetup': {
                                                          'nameTempl': self.name + 'MoveAll', 'size': 8,
    ...
    def generateRig(self, armRibbons=True, legRibbons=True, parentModules=True):
        ...
        if armRibbons:
            self.generateArmRibbons()

        if legRibbons:
            self.generateLegRibbons()
